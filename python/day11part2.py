...
#
# nb: the simplifying assumption - actual stone sequence doesn't matter according to those rules -
#     just track the number of each stone value created - turns out to be the thing that really 
#     lets Part 2 shine. See if you can spot the single-char (functional) difference in the code
#     between Part 1 and Part 2 solutions :-)
#
# Count the NUMBER of stones after 75 iterations.
...
if __name__ == "__main__" :
    ...
    print(f"PART TWO ANSWER: {sumStones(stones)}")