...
#
# Trail's score is the number of ROUTES to 9-height positions accessible from a 0-rated start point
...
if __name__ == "__main__" :
    ...
    sumTrails = 0
    for t in trailheads:
        summits = findPathsFromPosition(topomap,mapDim,t)
        tCount = len(summits)
        print(f"Start point {t} has {tCount} valid trails ending at {summits}")
        sumTrails += tCount
    print(f"PART TWO ANSWER is therefore {sumTrails}")